...
CREATE TABLE product (
  ...
  product_created_at bigint(99) NOT NULL,
  PRIMARY KEY (p_id),
...
CREATE TABLE orders (
  ...
  order_updated_at int(11) NOT NULL,
  PRIMARY KEY (o_id),
  FOREIGN KEY (user_id) REFERENCES user(u_id),
  FOREIGN KEY (billing_address_id) REFERENCES address(a_id),
  FOREIGN KEY (shipping_address_id) REFERENCES address(a_id),
  UNIQUE KEY id_UNIQUE (o_id)
...
INSERT INTO line_item VALUES (1,1,1,20,3),(2,2,1,25,1),(3,1,2,20,3),(4,1,2,25,1),(5,1,3,20,3),(6,2,3,25,1),(7,1,4,20,3),(8,2,4,25,1),(9,1,5,20,3),(10,2,5,25,1),(11,1,6,20,3),(12,2,6,25,1);
